...
Language.snippets = [
	...
	{ input : 'sfcss', output : '<?php echo stylesheet_tag(\'$\');?>' },
	{ input : 'sfjs', output : '<?php echo javascript_include_tag(\'$\');?>' },
	{ input : 'sfq', output : '$sql = "SELECT * FROM $";\n$stmt = $connection->prepareStatement($sql);\n$resultSet = $stmt->executeQuery();' },
	{ input : 'sffetch', output : 'while($resultSet->next()){\n $$=$resultSet->getString(\'$\');\n}' },
	{ input : 'sfimg', output : '<?php echo image_tag(\'$\');?>' },
	{ input : 'sflink', output : '<?php echo link_to(\'$\');?>' },
